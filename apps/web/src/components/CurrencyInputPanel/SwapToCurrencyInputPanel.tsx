...
interface SwapToCurrencyInputPanelProps {
  value: string
...
const SwapToCurrencyInputPanel = forwardRef<HTMLInputElement, SwapToCurrencyInputPanelProps>(
  (
    {
      value,
      onUserInput,
...
SwapToCurrencyInputPanel.displayName = 'SwapToCurrencyInputPanel'

export default SwapToCurrencyInputPanel
