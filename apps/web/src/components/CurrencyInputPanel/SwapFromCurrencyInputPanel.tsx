...
import CurrencySearchModal from 'components/SearchModal/CurrencySearchModal2'
...
const CurrencySelect = styled(ButtonGray)<CurrencySelectProps>`
  align-items: center;
...
interface SwapFromCurrencyInputPanelProps {
  value: string
...
const SwapFromCurrencyInputPanel = forwardRef<HTMLInputElement, SwapFromCurrencyInputPanelProps>(
  (
    {
      value,
      onUserInput,
...
SwapFromCurrencyInputPanel.displayName = 'SwapFromCurrencyInputPanel'

export default SwapFromCurrencyInputPanel
