...
import { getIsReviewableQuote2 } from 'pages/Swap2'
import { OutputTaxTooltipBody2 } from 'pages/Swap2/TaxTooltipBody'
        ...
        <div>
          {isLandingPage ? (
            ...
            <Trace
              ...
              properties={{ received_swap_quote: getIsReviewableQuote2(trade, tradeState, swapInputError) }}
            ...
            <Trace logPress element={InterfaceElementName.SWAP_BUTTON}>
              <ButtonError
                ...
                disabled={isUsingBlockedExtension || !getIsReviewableQuote2(trade, tradeState, swapInputError)}
              >
